...
| Angular velocity [`AngularVelocity`](iPhysics/src/quantity/angular_velocity.rs) | `i32`, Q24 | `2^-24 rad/s` = `5.96046e-8 rad/s` | `-100` to `100 rad/s` | Matches linear kinematic precision. The final practical limit may later also depend on collider radius and maximum surface speed. |
| Angular acceleration [`AngularAcceleration`](iPhysics/src/quantity/angular_acceleration.rs) | `i32`, Q24 | `2^-24 rad/s²` = `5.96046e-8 rad/s²` | `-100` to `100 rad/s²` | Symmetric with linear acceleration and leaves the same Q24 overflow headroom. |
