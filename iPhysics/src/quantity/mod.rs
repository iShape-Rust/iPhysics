...
pub(crate) const ANGULAR_ACCELERATION_FRACTION_BITS: u32 = 24;
pub(crate) const ANGULAR_VELOCITY_FRACTION_BITS: u32 = 16;
pub(crate) const ANGULAR_ACCELERATION_TO_VELOCITY_SHIFT: u32 =
    ANGULAR_ACCELERATION_FRACTION_BITS + TICKS_PER_SECOND.ilog2() - ANGULAR_VELOCITY_FRACTION_BITS;
